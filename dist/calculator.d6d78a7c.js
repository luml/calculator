...
var runningTotal = 0; // recent calculating number

var buffer = "0"; // recent calculating operator

var previousOperator;
var screen = document.querySelector('.screen'); // operation for different operator symbol, +=*/
